...
renderer.code = function(code, lang) {
  ...
  switch (lang) {
    ...
    case 'js':
      ...
      var jsfilename = filename + '-' + sha1(es5Code).substr(0,10) + '.js';
      var jsfile = new File({
  ...
  ret = renderHtml + '<div class="highlight"><pre class="hljs"><span class="code-type">' + lang + '</span><code class="' + lang + '">' + ret + '</code></pre></div>';
